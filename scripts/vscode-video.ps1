...
& $ffmpeg -hide_banner -loglevel warning -y -f gdigrab -framerate 15 -draw_mouse 1 -i desktop -t 46 -vf "scale=1280:-2" -c:v mpeg4 -q:v 4 -pix_fmt yuv420p -movflags +faststart $out
