...
export async function exportHTML(source: string, scene: Scene, frame: RuntimeFrame) {
  const response = await fetch(new URL('./site/assets/standalone.js', location.href));
