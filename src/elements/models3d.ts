...
import { advancePhase, readSignal, rotate, type Asset, type Signals } from './model';
import { registry } from './core-elements';
import { materialPresets, type MaterialPreset, type MaterialPresetId } from './materials';
