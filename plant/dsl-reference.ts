...
const pumps = system('pumps', 'Насосная группа', 'water')`,
  },
  {
    ...
    category: 'Model',
    summary: 'Экземпляр установленной динамической модели. Выходы несут literal ID, value type, unit и physical dimension; входы проверяют совместимость этих типов ещё в TypeScript.',
...
// pump.flow → SignalRef<..., number, 'отн.', 'flow'>`,
  ...
  },
  {
    ...
    category: 'Signals',
    summary: 'Стабильная ссылка на сигнал по ID. Известные выходы simulation/control/PLC несут literal ID, value type, unit и dimension; строковый signal(path) остаётся явным escape hatch с dimension=unknown.',
  ...
  },
  {
    ...
    category: 'Signals',
    summary: 'Агрегирует только числовой выход группы моделей и сохраняет его physical dimension через mean/sum/min/max.',
