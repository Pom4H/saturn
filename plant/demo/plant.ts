...
export default project('chernobyl-study', {
    ...
    simulations: [grid, pumpA, pumpB, reactor, ...channels, separatorA, separatorB, turbine, condenser, sensor, protection, building, ...auxiliary, ...services, ...trainingNodes],
    controls: [...controls, ...trainingControls],
    signals: coreSignals,
    alarms: [
        ...auxiliaryAlarms, ...trainingAlarms,
