...
- Designer: `src/view.ts`, `src/view3d.ts`, `src/style.css`, `src/visual-components.ts`, `src/components/filter/visual.ts`, `src/elements/models3d.ts`, `examples/elements-lab/**`; representation hooks and visual review.
